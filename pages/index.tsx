                ...
                <Grid align="center" justify="center" style={{ height: '100px', flexWrap: 'nowrap' }}>
                    <Grid.Col span={3}>
                        <Image
                            ...
                            style={{ maxHeight: '50%', maxWidth: '50%', objectFit: 'contain', marginLeft: 'auto', marginRight: 'auto'}}
                        />
                    </Grid.Col>
                    <Grid.Col span={3} style={{ textAlign: 'center' }}>
                        <Image
                            ...
                            style={{ maxHeight: '30%', maxWidth: '30%', objectFit: 'contain', marginLeft: 'auto', marginRight: 'auto' }}
                        />
                    </Grid.Col>
                    <Grid.Col span={3}>
                        <Image
